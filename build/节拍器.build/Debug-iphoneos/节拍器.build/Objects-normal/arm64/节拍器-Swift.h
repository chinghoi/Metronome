...
SWIFT_CLASS("_TtC9节拍器11AppDelegate")
...
SWIFT_CLASS("_TtC9节拍器14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet CircularSlider * _Null_unspecified circular;
...
- (void)playD_d;
- (void)playD_dd;
- (NSInteger)setupSlider SWIFT_WARN_UNUSED_RESULT;
- (void)updateValue;
- (void)adjustValue;
- (IBAction)noteChanged:(id _Nonnull)sender;
